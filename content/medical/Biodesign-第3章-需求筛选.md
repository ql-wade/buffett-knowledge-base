...
| 规律陈述 | 抽象层级 | 知识连接 | 适用范围 |
|----------|----------|----------|----------|
| **数据筛选定律**：创新决策的质量取决于筛选流程的独立性——快速打分和深度调查必须分开执行，否则直觉偏差会污染整个流程 | 决策科学/认知心理学 | [[思考快与慢]]（系统1与系统2）、贝叶斯决策理论 | 投资决策、人才筛选、项目优先级排序 |
| **偏差对称定律**：人在评估机会时存在对称性偏差——高估有利面（技术可行性、市场规模），低估不利面（监管成本、报销难度），这种偏差在所有受监管行业都成立 | 行为经济学/认知偏差研究 | [[思考快与慢]]（乐观偏差、规划谬误）、规划谬误（Planning Fallacy） | 创业评估、政策制定、个人重大决策 |
